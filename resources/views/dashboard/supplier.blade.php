...
<div>
    <div class="mb-4 border-bottom border-1">
        <div class="d-flex mb-0 pb-0">
            ...
            class="text-decoration-none ps-0 py-2 pe-2 ms-0 fw-bold {{ Request::is('karuniamotor/dashboard/supplier') ? 'text-primary' : 'text-danger' }}">Daftar
            Supplier</a>
            <div class="border-end border-1 mb-1 mt-1"></div>
            <a href="/karuniamotor/dashboard/supplier/add"
            class="text-decoration-none ps-2 py-2 ms-0 fw-bold {{ Request::is('karuniamotor/dashboard/supplier/add') ? 'text-primary' : 'text-danger' }}">Tambah
            Supplier</a>
