    ...
    <div class="mb-4 border-bottom border-1">
        <div class="d-flex mb-0 pb-0">
            <a href="/karuniamotor/dashboard/transaction-list"
                class="text-decoration-none ps-0 py-2 pe-2 ms-0 fw-bold {{ Request::is('karuniamotor/dashboard/transaction-list') ? 'text-primary' : 'text-danger' }}">Daftar
                Transaksi
            </a>
            <div class="border-end border-1 mb-1 mt-1"></div>
            <a href="/karuniamotor/dashboard/transaction-list/pending"
                class="text-decoration-none ps-2 py-2 pe-2 ms-0 fw-bold {{ Request::is('karuniamotor/dashboard/transaction-list/pending') ? 'text-primary' : 'text-danger' }}">Daftar
                Transaksi Pending
            </a>
