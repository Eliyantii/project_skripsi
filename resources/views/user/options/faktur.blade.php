                ...
                <div class="ps-2">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="text-start">
                            <p class="fw-semibold">{{ ucwords($user->name) }}</p>
                        </div>
                    </div>
                    <div class="d-flex justify-content-between">
                        <div>
                        ...
                        <div class="text-start">
                            <p class="fw-semibold">{{ ucwords($user->address) }}</p>
                        </div>
                    </div>
                    <div class="d-flex justify-content-between">
                        <div>
            ...
            <div class="mb-3">
                ...
                <div class="ps-2">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="text-start">
                            <p class="fw-semibold">{{ ucwords($historyProduct->brand) }}</p>
                        </div>
                    </div>
                    <div class="d-flex justify-content-between">
                        <div>
                        ...
                        <div class="text-start">
                            <p class="fw-semibold">{{ ucwords($historyProduct->name) }}</p>
                        </div>
                    </div>
                    <div class="d-flex justify-content-between">
                        <div>
                        ...
                        <div class="text-start">
                            <p class="fw-semibold">{{ $historyProduct->year }}</p>
                        </div>
                    </div>
                    <div class="d-flex justify-content-between">
                        <div>
                        ...
                        <div class="text-start">
                            <p class="fw-semibold">{{ strtoupper($historyProduct->frame_number) }}</p>
                        </div>
                    </div>
                    <div class="d-flex justify-content-between">
                        <div>
                        ...
                        <div class="text-start">
                            <p class="fw-semibold">{{ strtoupper($historyProduct->machine_number) }}</p>
                        </div>
                    </div>
                    <div class="d-flex justify-content-between">
                        <div>
                        ...
                        <div class="text-start">
                            <p class="fw-semibold">Rp{{ number_format($historyProduct->price, 2, ',','.') }}</p>
                        </div>
                    </div>
                </div>
            </div>
