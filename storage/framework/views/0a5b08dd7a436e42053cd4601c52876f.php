                ...
                <table class="table table-sm table-bordered table-hover shadow-sm text-center">
                    ...
                    <tbody>
                        ...
                        <tr class="align-middle" style="cursor: pointer" onclick="showOfferDetailPopUp('<?php echo e($product->id); ?>');">
                            ...
                            <td><?php echo e(($product->offer_price == null) ? "Rp0" : "Rp". number_format($product->offer_price, 2, ',', '.')); ?>
                            ...
                            <td class="d-flex justify-content-center align-items-center">
                                ...
                                <form action="/karuniamotor/dashboard/offer/accept/<?php echo e($product->id); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('dashboard.penawaranPelanggan', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Skripsi\program\karunia-motor-eli\karuniaApp\resources\views/dashboard/options/daftarPenawaran.blade.php ENDPATH**/ ?>