    ...
    <div class="container-fluid mx-3">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="list-group list-group-flush my-3">
                    ...
                    <li class="list-group-item rounded">
                        <button type="button" class="btn dropdown-item position-relative" data-bs-toggle="modal"
                            ...
                            <span
                                class="position-absolute top-50 start-100 translate-middle badge rounded-pill bg-danger"><?php echo e(($countNotif > 99) ? '99+' : $countNotif); ?></span>
                        </button>
                    </li>
                    <li class="list-group-item rounded">
            ...
            <form class="d-none d-lg-flex col-lg-6 ms-lg-auto" role="search" action="/">
                <?php echo csrf_field(); ?>
                <input class="form-control me-2" type="search" name="search" placeholder="Cari motor..." aria-label="Search" value="<?php echo e(request('search')); ?>">
                <button class="btn btn-outline-light" type="submit">Cari</button>
            </form>
...
<?php /**PATH D:\Skripsi\program\karunia-motor-eli\karuniaApp\resources\views/home/components/navbar.blade.php ENDPATH**/ ?>