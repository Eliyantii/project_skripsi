...
<div id="carouselExampleIndicators" class="carousel slide slider col-12 mx-3 my-3">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="/assets/banner_1.jpg" class="d-block w-100 h-50" alt="Image">
      </div>
      <div class="carousel-item">
        <img src="/assets/banner_2.jpg" class="d-block w-100 h-50" alt="Image">
      </div>
    </div>
...
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('home.layouts.utama', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Development\karunia-motor-eli\karuniaApp\resources\views/beranda.blade.php ENDPATH**/ ?>