    ...
    <div class="mb-4 border-bottom border-1">
        <div class="d-flex mb-0 pb-0">
            <a href="/karuniamotor/dashboard/product"
                class="text-decoration-none ps-0 py-2 ms-0 pe-2 fw-bold <?php echo e(Request::is('karuniamotor/dashboard/product') ? 'text-primary' : 'text-danger'); ?>">Daftar
                Motor
            </a>
            <div class="border-end border-1 mb-1 mt-1"></div>
            <a href="/karuniamotor/dashboard/product/add"
                class="text-decoration-none ps-2 py-2 ms-0 fw-bold <?php echo e(Request::is('karuniamotor/dashboard/product/add') ? 'text-primary' : 'text-danger'); ?>">Tambah
                Motor
            </a>
            <div class="ms-auto">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Skripsi\program\karunia-motor-eli\karuniaApp\resources\views/dashboard/produk.blade.php ENDPATH**/ ?>